...
/* themes/custom/austry/templates/paragraph/countdown/field--paragraph--field-valeur-numerique.html.twig */
class __TwigTemplate_49139fb9fc82c9a4fb0d2f2405fce158 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "     <h3 class=\"count-text\" data-stop=\"";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = (($__internal_compile_1 = twig_get_attribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 65)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["#context"] ?? null) : null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["value"] ?? null) : null), 65, $this->source), "html", null, true);
                    echo "\" data-speed=\"1500\">00</h3>
    ";
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['item'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "themes/custom/austry/templates/paragraph/countdown/field--paragraph--field-valeur-numerique.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
     <h3 class=\"count-text\" data-stop=\"{{item.content['#context']['value']}}\" data-speed=\"1500\">00</h3>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/custom/austry/templates/paragraph/countdown/field--paragraph--field-valeur-numerique.html.twig", "/Users/myguest/Aventure_drupal/theming/web/themes/custom/austry/templates/paragraph/countdown/field--paragraph--field-valeur-numerique.html.twig");
    }
