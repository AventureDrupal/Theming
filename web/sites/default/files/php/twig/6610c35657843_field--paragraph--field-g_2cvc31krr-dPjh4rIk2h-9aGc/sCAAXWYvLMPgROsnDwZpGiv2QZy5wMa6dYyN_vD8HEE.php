...
/* themes/custom/austry/templates/paragraph/grid_multi_columns/field--paragraph--field-grid-multi-content.html.twig */
class __TwigTemplate_237a895f042e2937324516b559f207bd extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
            ...
            if (($context["multiple"] ?? null)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 60
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 60), "addClass", [0 => "col-xl-4 col-lg-4"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/custom/austry/templates/paragraph/grid_multi_columns/field--paragraph--field-grid-multi-content.html.twig";
    }
    ...
    {
        return array (  136 => 78,  133 => 77,  122 => 75,  117 => 74,  113 => 72,  111 => 71,  105 => 70,  100 => 69,  96 => 67,  93 => 66,  82 => 64,  77 => 63,  74 => 62,  63 => 60,  58 => 59,  56 => 58,  53 => 57,  51 => 56,  48 => 55,  46 => 52,  45 => 50,  43 => 46,  42 => 45,  41 => 44,  40 => 43,  39 => 41,);
    }
...
{% if label_hidden %}
  ...
  {% if multiple %}
      {% for item in items %}
        <div{{ item.attributes.addClass('col-xl-4 col-lg-4') }}>{{ item.content }}</div>
      {% endfor %}
  {% else %}
    {% for item in items %}
...
{% else %}
  <div{{ attributes.addClass(classes) }}>
    ...
    {% endif %}
{% endif %}
", "themes/custom/austry/templates/paragraph/grid_multi_columns/field--paragraph--field-grid-multi-content.html.twig", "/Users/myguest/Aventure_drupal/theming/web/themes/custom/austry/templates/paragraph/grid_multi_columns/field--paragraph--field-grid-multi-content.html.twig");
    }
