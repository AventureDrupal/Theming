...
/* themes/custom/austry/templates/paragraph/yearOfExperience/field--paragraph--field-second-image.html.twig */
class __TwigTemplate_ef1bf04257622b6f50845fb00df97a4e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div class=\"about-one__img-2\">";
...
";
    ...
    {
        return "themes/custom/austry/templates/paragraph/yearOfExperience/field--paragraph--field-second-image.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div class=\"about-one__img-2\">{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/custom/austry/templates/paragraph/yearOfExperience/field--paragraph--field-second-image.html.twig", "/Users/myguest/Aventure_drupal/theming/web/themes/custom/austry/templates/paragraph/yearOfExperience/field--paragraph--field-second-image.html.twig");
    }
